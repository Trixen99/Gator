...
) select insertedfeedfollow.id, insertedfeedfollow.created_at, insertedfeedfollow.updated_at, insertedfeedfollow.user_id, insertedfeedfollow.feed_id, feeds.name, users.name
